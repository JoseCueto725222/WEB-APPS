...
<?php include ('session.php');?>
	...
	<div id="header">
		<div class="head-view">
			<ul>
				<li><a href="home.php" title="Biobook"><b>Kingstagram</b></a></li>
				<li></li>
				<li></li>
				<li></li>
				<li></li>
	...
	<div>
			<form method="post" action="post.php" enctype="multipart/form-data">
				<textarea placeholder="Post Something!" name="content" class="post-text" required></textarea>
				<input type="file" name="image">
				<button class="btn-share" name="Submit" value="Log out">Post</button>
			</form>
	</div>
